...
public class RoomAspect {
	...
	@AfterReturning(value="execution(public * com.rba.demo.controller.RoomBookingController.insertRoom(..))",returning = "responseEntity")
	public void insertRoom(Object responseEntity) {
		
		System.out.println(responseEntity);
		//System.out.println(responseEntity.getBody());
		ResponseEntity<RoomDTO> re = (ResponseEntity<RoomDTO>) responseEntity;
