...
//	}
	...
	public Room findByRoomId(@PathVariable int roomId) throws RoomIDNotFoundException {
		...
		if(room == null) {
			...
			throw new RoomIDNotFoundException("Hey, Sorry The Given Room Id: "+roomId+"Not Available");
		}
	...
	public void updateRoom(@RequestBody Room room,@PathVariable int roomId) {
		
	}
	
	@DeleteMapping("/rooms/{roomId}")
	public void updateRoom(@PathVariable int roomId) {
